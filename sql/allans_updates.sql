...
CREATE TABLE IF NOT EXISTS `mapConnections` (
  ...
  `fromSolarSystemID` int(11) DEFAULT NULL,
  `stargateID` int(11) DEFAULT NULL,
  `celestialID` int(11) DEFAULT NULL,
  `toSolarSystemID` int(11) DEFAULT NULL,
  `toConstellationID` int(11) DEFAULT NULL,
  `toRegionID` int(11) DEFAULT NULL,
  KEY `fromRegionID` (`fromRegionID`,`fromConstellationID`,`fromSolarSystemID`,`toSolarSystemID`,`toConstellationID`,`toRegionID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
/* Dumping data for table `roidDistribution`  */
