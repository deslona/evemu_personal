...
PyCallable_Make_InnerDispatcher(Trade)

Trade::Trade(PyServiceMgr *mgr)
...
/*
PyResult Trade::Handle_( PyCallArgs& call )
{
    sLog.Log( "Trade", "Handle_" );
  call.Dump(SERVICE__CALLS);
